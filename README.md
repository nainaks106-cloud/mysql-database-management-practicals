...
The goal of this project is to design, modify, manage, and restructure a complete relational database schema that handles:
...
Apply CHECK, UNIQUE, DEFAULT, NOT NULL constraints

Perform ALTER, DROP, RENAME, TRUNCATE operations
